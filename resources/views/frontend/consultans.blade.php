      ...
      <div class="col-md-6">
        ...
        <form action="{{ route('consultans.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="sectors" class="form-label">Sectores de Interés</label><span class="text-danger ms-1">*</span>
              <button class="btn btn-outline-secondary dropdown-toggle w-100" type="button" data-bs-toggle="dropdown"
                aria-expanded="false">Seleccionar una opción
              </button>
              ...
              <ul class="dropdown-menu dropdown_consultants" aria-labelledby="dropdownMenuButton">
                @foreach ($sectors as $sector)
                  <li class="dropdown-item"><label><input type="checkbox" name="sectors[]"
                        class="align-middle me-2 item{{ $sector->id }}" value="{{ $sector->id }}"
