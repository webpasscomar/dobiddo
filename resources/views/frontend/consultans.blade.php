        ...
        <div class="row gx-0 gx-md-5">
            <div class="col-md-5">
                ...
                <p>
                    ...
                    a la comunidad dobiddo formarás parte del roster de consultores dobiddo y recibirás muchos consejos para
                    postularte a los llamados de los principales organismos de desarrollo.
                </p>
                <p> <b> ¿Te sumas? </b></p>

                <img src="{{ asset('img/consultores/consultor.png') }}" class="img-fluid ms-0 ms-md-5 mt-5 mb-3 mb-md-0"
            ...
            <div class="col-md-7 {{ $errors->any() ? 'mb-5' : '' }}">
              ...
              <input type="file" class="form-control" id="cv" name="cv" accept=".pdf"> --}}
                    ...
                    <button type="submit" class="btn btn_consultants-submit text-white">Enviar</button>
                </form>
