  ...
  <div class="container mb-4">
    <div class="card px-1 px-md-4 py-3 shadow-lg-responsive">
      ...
      <div class="d-none d-sm-block align-self-end my-3">
        ...
        <a role="button" class="calls_share" onclick="shareByEmail('{{ url()->current() }}')" title="Enviar por Correo">
        ...
        <a role="button" class="calls_share" onclick="shareOnLinkedIn('{{ url()->current() }}')"
      ...
      <div class="card-body">
            ...
            <div class="col-md-12">
              ...
              <ul>
                @foreach ($call->sectors as $sector)
                  <li class="nav-link">
                    <img src="{{ asset('img/elementos/check-circle.png') }}" alt="sectores" width="20"
                      class="me-2">
                    {{-- <i
        ...
        <div>
          ...
          <div class="d-block d-sm-none align-self-end my-3 mt-5">
            ...
            <a role="button" class="calls_share" onclick="shareOnWhatsApp('{{ url()->current() }}')"
              title="Compartir en Whatsapp">
              <img src="{{ asset('img/social_media_iconos/whatsapp-circle.svg') }}" alt="whatsapp" width="30"
                class="m-1">
            </a>

            <a role="button" class="calls_share" onclick="shareByEmail('{{ url()->current() }}')"
              title="Enviar por Correo">
              <img src="{{ asset('img/social_media_iconos/mail-circle.svg') }}" alt="correo" width="30"
                class="m-1">
            </a>

            <a role="button" class="calls_share" onclick="shareOnTwitter('{{ url()->current() }}')"
              title="Compartir Red social X (ex Twitter)">
              <img src="{{ asset('img/social_media_iconos/twitter-circle.svg') }}" alt="Red Social X" width="30"
                class="m-1">
            </a>

            <a role="button" class="calls_share" onclick="shareOnFacebook('{{ url()->current() }}')"
              title="Compartir en Facebook">
              <img src="{{ asset('img/social_media_iconos/facebook-circle.svg') }}" alt="Facebook" width="30"
                class="m-1">
            </a>

            <a role="button" class="calls_share" onclick="shareOnLinkedIn('{{ url()->current() }}')"
              title="Compartir en Linkedin">
              <img src="{{ asset('img/social_media_iconos/linkedin-circle.svg') }}" alt="Linkedin" width="30"
                class="m-1">
            </a>

            <a role="button" class="calls_share" id="btnCopyURL" data-clipboard-text="{{ url()->current() }}"
              title="Copiar al portapapeles">
              <img src="{{ asset('img/social_media_iconos/copy-circle.svg') }}" alt="copiar al portapapeles"
                width="30" class="m-1">
            </a>
...
@push('js')
  ...
  <script>
    ...
    // funcionalidad compartir en LinkedIn
