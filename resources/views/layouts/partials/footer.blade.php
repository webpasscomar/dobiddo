      ...
      <div class="container-fluid calls_banner py-4 mt-5">
        <div class="container">
          <div class="row gy-4 gy-md-0 align-items-center text-center">
            ...
            <div class="col-md-4">
              <img src="{{ asset('img/logotipos/12 Logo claim centrado blanco.png') }}" alt="dobiddo the bid doers"
                class="img-fluid calls_banner-images">
            </div>
          </div>
        </div>
      ...
      <div class="container py-4">
        <div class="row">
          ...
          <div class="col-md-5 mb-3">
            ...
            <p class="text-white"><a href="mailto: info@dobiddo.com" class="link_webpass" target="_blank">Email:
                info@dobiddo.com</a>
            </p>
          ...
          <div class="col-md-5 mb-3">
            ...
            <ul class="list-unstyled text-white-50 light">
              ...
              <li>
                <a href="https://webpass.com.ar" class="link_webpass" target="_blank">Diseño y Desarrollo</a> by WebPass
              </li>
            </ul>
          </div>
